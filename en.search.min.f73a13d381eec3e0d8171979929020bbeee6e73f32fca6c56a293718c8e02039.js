...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.320c4c6d7dac73fc4e0d85755640f810acdd891d3cd03e2a560513c0d89a8672.js',function(){input.required=false;search();});}
