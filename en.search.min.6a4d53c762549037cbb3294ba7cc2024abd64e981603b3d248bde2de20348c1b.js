...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.40c1d8f658fdc981a9481222c8b3ca7f07d7058c3cddd595bd6fb5852aa545ae.js',function(){input.required=false;search();});}
