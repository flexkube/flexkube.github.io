...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3a31e471ede2134a4a5d76a847cdeabd30416332600e1c825864541ca767d334.js',function(){input.required=false;search();});}
